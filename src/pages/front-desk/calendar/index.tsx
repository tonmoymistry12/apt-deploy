...
const Calendar: React.FC = () => {
	...
	const handleDoctorSelect = async (doctor: any | null) => {
		console.log("======================");
		//console.log(selectedDoctor.userUid);
		console.log("======================");
	...
	const handleConfirm = async (
		...
		try {
			...
			// Call the API
			const response = await addSlot(payload, selectedDoctor);
											...
											<TableBody>
												{calendars.map((cal, idx) => {
													...
													if (
														...
														slotCount++;
													if (
														cal.mondayStartTime2 &&
														cal.mondayStartTime2 !== "00:00"
													)
														slotCount++;
													if (
														cal.tuesdayStartTime1 &&
														cal.tuesdayStartTime1 !== "00:00"
													)
														slotCount++;
													if (
														cal.tuesdayStartTime2 &&
														cal.tuesdayStartTime2 !== "00:00"
													)
														slotCount++;
													if (
														cal.wednesdayStartTime1 &&
														cal.wednesdayStartTime1 !== "00:00"
													)
														slotCount++;
													if (
														cal.wednesdayStartTime2 &&
														cal.wednesdayStartTime2 !== "00:00"
													)
														slotCount++;
													if (
														cal.thursdayStartTime1 &&
														cal.thursdayStartTime1 !== "00:00"
													)
														slotCount++;
													if (
														cal.thursdayStartTime2 &&
														cal.thursdayStartTime2 !== "00:00"
													)
														slotCount++;
													if (
														cal.fridayStartTime1 &&
														cal.fridayStartTime1 !== "00:00"
													)
														slotCount++;
													if (
														cal.fridayStartTime2 &&
														cal.fridayStartTime2 !== "00:00"
													)
														slotCount++;
													if (
														cal.saturdayStartTime1 &&
														cal.saturdayStartTime1 !== "00:00"
													)
														slotCount++;
													if (
														cal.saturdayStartTime2 &&
